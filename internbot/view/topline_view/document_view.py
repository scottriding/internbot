...
class DocumentView(BoxLayout):
	...
	def __init__(self, **kwargs):
		...
		self.save_log_dialog = self.create_save_log_dialog()
	...
	def create_other_template_dialog(self):
		...
		def open_file(path, filename):
			try:
				...
				self.__log_text += "Error with template selection\n"
	...
	def create_save_log_dialog(self):
		chooser = BoxLayout()
		container = BoxLayout(orientation='vertical')
		...
		file_name = TextInput(text="File name.txt")
		button_layout.add_widget(file_name)
